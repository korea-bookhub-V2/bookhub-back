...
public class MailServiceImpl implements MailService {
    ...
    public Mono<ResponseEntity<ResponseDto<String>>> sendEmailFindId(LoginIdFindSendEmailRequestDto dto) {
        return Mono.fromCallable(() -> {
            ...
            String token = jwtTokenProvider.generateEmailToken(dto.getEmail(), employee.getLoginId());
        ...
        return Mono.fromCallable(() -> {
            if (!jwtTokenProvider.validateToken(token)) {
                return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ResponseDto.fail(ResponseCode.INVALID_TOKEN, ResponseMessageKorean.INVALID_TOKEN));
            }
    ...
    public Mono<ResponseEntity<ResponseDto<String>>> sendEmailResetPassword(PasswordFindSendEmailRequestDto dto) {
        return Mono.fromCallable(() -> {
            ...
            if (employee == null) {
                return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ResponseDto.fail(ResponseCode.NO_EXIST_USER_ID, ResponseMessageKorean.NO_EXIST_USER_ID));
            }
